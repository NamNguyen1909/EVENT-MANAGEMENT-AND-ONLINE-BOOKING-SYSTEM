    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tickets', models.ManyToManyField(blank=True, related_name='payments', to='bem.ticket')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            options={
                'indexes': [models.Index(fields=['event', 'user'], name='bem_review_event_i_b87caa_idx'), models.Index(fields=['parent_review'], name='bem_review_parent__0cc43a_idx')],
            },
        ),
        migrations.AddIndex(
            model_name='event',
