# Generated by Django 5.1.7 on 2025-04-19 09:17
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('event', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='trending_logs', to='bem.event')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            options={
                'indexes': [models.Index(fields=['user', 'status'], name='bem_payment_user_id_67b948_idx'), models.Index(fields=['transaction_id'], name='bem_payment_transac_7c5dfd_idx')],
            },
        ),
        migrations.CreateModel(
            name='Review',
